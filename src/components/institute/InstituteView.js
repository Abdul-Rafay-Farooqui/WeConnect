  ...
  const courseData = {
    assignments: [
      ...
      },
      {
        ...
        status: "submitted",
        points: 50,
        description: "Write an essay on the course topic",
      },
      {
        id: 3,
        title: "Lab Report #3",
        ...
        points: 25,
        score: 23,
        description: "Document your lab findings",
      },
    ],
    quizzes: [
      {
    ...
    discussions: [
      {
        id: 1,
        title: "Week 5: Data Structures Discussion",
        author: "Prof. Smith",
        replies: 12,
    ...
    announcements: [
      {
        ...
        content: "The midterm will be held on Feb 25th",
        date: "2 days ago",
        important: true,
      },
      {
        ...
        content: "Office hours moved to Thursdays 2-4 PM",
        date: "5 days ago",
        important: false,
      },
      {
        ...
        content: "Check the assignments tab for details",
        date: "1 week ago",
        important: false,
      },
    ],
              ...
              <div
                onClick={() =>
                  setSelectedInstitute(
                    selectedInstitute === institute.id ? null : institute.id,
                  )
                }
                style={{
                  padding: "16px 20px",
                ...
                onMouseEnter={(e) => {
                  if (selectedInstitute !== institute.id)
                  ...
                  {institute.courses.map((course, idx) => (
                    <div
                      ...
                      style={{
                        ...
                        borderLeft:
                          selectedCourse === course
                            ? "3px solid hsl(var(--accent-secondary))"
      ...
      >
        {selectedCourse ? (
            ...
            >
              {activeTab === "overview" && (
                <div>
                  ...
                  >
                    Course at a glance: assignment count, quizzes, attendance
                    rate, and your overall grade. Click a card to jump to that
                    section. Recent announcements are shown below.
                  </p>
                  <div
                    style={{
                      display: "grid",
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {Math.round(
                          (courseData.attendance.filter(
                            (a) => a.status === "present",
                          ).length /
                            courseData.attendance.length) *
                            100,
                        )}
                        %
                      </div>
                  ...
                  >
                    ...
                    >
                      Latest updates from your instructor. Important items are
                      highlighted.
                    </p>
                      ...
                      .map((announcement) => (
                        <div
                          ...
                          style={{
                            padding: "12px",
                            marginBottom: "8px",
                            borderLeft: announcement.important
                              ? "3px solid hsl(var(--accent-warning))"
                              : "3px solid hsl(var(--border-subtle))",
              ...
              {activeTab === "assignments" && (
                ...
                >
                  ...
                  >
                    View and submit assignments. Each shows due date, points,
                    and status (pending, submitted, or graded). Upload your work
                    before the due date and check back for feedback and scores.
                  </p>
              ...
              {activeTab === "live-classes" && (
                <div>
                  ...
                  >
                    Join scheduled lectures and lab sessions in real time. See
                    instructor, use chat, and share your screen. Upcoming
                    sessions show date, time, and attendee count.
                  </p>
                  {/* Live Class Stats */}
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {courseData.liveClasses.reduce(
                          (sum, c) => sum + c.attendees,
                          0,
                        )}
                      </div>
                      <div
              ...
              {activeTab === "quizzes" && (
                ...
                >
                  ...
                  >
                    Take quizzes before the due date. Each shows number of
                    questions and total points. Your score is available after
                    submission. Start when ready — complete in one sitting.
                  </p>
              ...
              {activeTab === "grades" && (
                ...
                >
                  ...
                  >
                    Your overall grade is a weighted average of assignments,
                    quizzes, midterm, and final. N/A means that component is not
                    yet graded. Weights show how much each category counts.
                  </p>
                  ...
                  >
                    Score and points per category. Weight is the percentage of
                    your final grade.
                  </p>
              ...
              {activeTab === "discussions" && (
                <div>
                  ...
                  >
                    Start or join discussions with your instructor and
                    classmates. Each thread shows author, reply count, and last
                    activity. Click to read and reply.
                  </p>
                  <div
                    style={{
                      display: "flex",
              ...
              {activeTab === "resources" && (
                <div>
                  ...
                  >
                    Lecture slides, readings, and other materials shared by your
                    instructor. Download to view offline. Files show size,
                    uploader, and date.
                  </p>
                  <div
                    style={{
              ...
              {activeTab === "study-groups" && (
                <div>
                  ...
                  >
                    Join or create groups to study with classmates. Each group
                    has a topic and member count. Join to participate and see
                    last activity.
                  </p>
                  <div
                    style={{
                      ...
                      >
                        ...
                        >
                          <div style={{ flex: 1 }}>
                            ...
                            >
                              👥 {group.members} members • 🕐 Last activity:{" "}
                              {group.lastActivity}
                            </div>
                          </div>
                          <button
              ...
              {activeTab === "announcements" && (
                <div>
                  ...
                  >
                    Official updates from your instructor: exam dates, office
                    hours, new assignments, and other course news. Important
                    announcements are marked with a warning.
                  </p>
                  <div
                    style={{
                      display: "flex",
                    ...
                    {courseData.announcements.map((announcement) => (
                      <div
                        ...
                        style={{
                          ...
                          borderRadius: "var(--radius-md)",
                          borderLeft: announcement.important
                            ? "4px solid hsl(var(--accent-warning))"
                            : "4px solid hsl(var(--border-subtle))",
                        }}
                      >
                        <div
                          style={{
          ...
          >
            ...
            >
              Access your assignments, quizzes, grades, discussions, and course
