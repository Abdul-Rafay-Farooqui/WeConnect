  ...
  const teamData = {
    chat: [
      ...
      },
      {
        id: 2,
        sender: "Sarah Lee",
        message: "Updated the design files @John",
        time: "3:30 PM",
        avatar: "👩‍🎨",
        reactions: [],
        mentions: ["John"],
    ...
    tasks: [
      {
        ...
        priority: "high",
        status: "in-progress",
        description: "Finalize quarterly report with all metrics",
      },
      {
        id: 2,
    ...
    activity: [
      {
        ...
        user: "Sarah Lee",
        text: "mentioned you",
        preview: "Updated the design files @John",
        time: "30m ago",
        unread: true,
      },
      {
    ...
    approvals: [
      ...
      {
        id: 2,
        title: "Purchase approval - New monitors",
        type: "Purchase",
        requestedBy: "Sarah Lee",
        amount: "$2,400",
        status: "pending",
        description: '5x 27" monitors for design team',
      },
      {
        id: 3,
    ...
    praise: [
      {
        ...
        to: "Sarah Lee",
        badge: "🌟 Great work",
        message: "Amazing design on the Q4 dashboard!",
        time: "Yesterday",
      },
      {
        id: 2,
        ...
        to: "Mike Chen",
        badge: "🚀 Team player",
        message: "Thanks for the quick API docs.",
        time: "2 days ago",
      },
    ],
    shifts: [
      ...
      >
        {selectedTeam ? (
            ...
            >
              {activeTab === "chat" && (
                ...
                >
                  ...
                  >
                    Team chat — send messages, @mention colleagues, and use
                    formatting. Replies and reactions appear here.
                  </p>
              ...
              {activeTab === "activity" && (
                <div>
                  ...
                  >
                    Your mentions, replies, reactions, and file shares in this
                    team. Unread items are highlighted.
                  </p>
                  <div
                    style={{
                      display: "flex",
                      ...
                      <div
                        ...
                        style={{
                          ...
                          borderLeft: item.unread
                            ? "4px solid hsl(var(--accent-primary))"
              ...
              {activeTab === "files" && (
                <div>
                  ...
                  >
                    Files shared in this team. You can download, preview, or
                    open in app. Uploads are visible to all team members.
                  </p>
                  <div
                    style={{
                      display: "flex",
              ...
              {activeTab === "meetings" && (
                <div>
                  ...
                  >
                    Join or schedule team meetings. Use Meeting options to
                    enable recording, live captions, raise hand, and breakout
                    rooms.
                  </p>
                  <div
                    style={{
              ...
              {activeTab === "tasks" && (
                <div>
                  ...
                  >
                    Track work with assignee, due date, and priority. Move tasks
                    through To do → In progress → Completed.
                  </p>
                  {/* Task Stats */}
                  <div
                    style={{
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {
                          teamData.tasks.filter((t) => t.status === "todo")
                            .length
                        }
                      </div>
                      <div
                    ...
                    >
                      ...
                      >
                        {
                          teamData.tasks.filter((t) => t.status === "completed")
                            .length
                        }
                      </div>
                      <div
              ...
              {activeTab === "calendar" && (
                <div>
                  ...
                  >
                    View meetings and events. Dots on dates indicate scheduled
                    items. Click a date to see details.
                  </p>
                  {/* Calendar View */}
                  <div
                    className="glass"
                  ...
                  >
                    ...
                    >
                      {Array.from({ length: 35 }, (_, i) => {
                        const date = i + 1;
                        const hasMeeting = teamData.meetings.some(
                          (m) => m.date === "Today" && date === 16,
                        );
                        return (
                          <div
                            key={i}
              ...
              {activeTab === "attendance" && (
                <div>
                  ...
                  >
                    Sign-in and sign-out times for the team. View who is
                    present, active, or absent and total hours worked.
                  </p>
                  <div
                    style={{
                      display: "flex",
                  ...
                  >
                    ...
                    >
                      Sign-in and sign-out timestamps with total hours. Status:
                      present (signed out), active (signed in), or absent.
                    </p>
                    {teamData.attendance.map((record) => (
                      ...
                      >
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          >
                            Sign In: {record.signIn} | Sign Out:{" "}
                            {record.signOut} | Hours: {record.hours}h
                          </div>
                        </div>
                        <div
                          style={{
              ...
              {activeTab === "approvals" && (
                <div>
                  ...
                  >
                    Review and approve leave, purchases, timesheets, and other
                    requests. Approve or reject with one click.
                  </p>
                  <div
                    style={{
                      display: "flex",
              ...
              {activeTab === "praise" && (
                <div>
                  ...
                  >
                    Recognize teammates with badges and a short message. Sent
                    praise appears here for the whole team to see.
                  </p>
                  <div
                    style={{
                      display: "flex",
              ...
              {activeTab === "shifts" && (
                <div>
                  ...
                  >
                    View who is scheduled and when. Use this to plan coverage
                    and see who is working today or tomorrow.
                  </p>
                  <div
                    style={{
                      display: "flex",
              ...
              >
                ...
                >
                  <div style={{ textAlign: "center" }}>
                    ...
                    <div>
                      Whiteboard Canvas - Draw, annotate, and collaborate in
                      real-time
                    </div>
                  </div>
                </div>
          ...
          >
            ...
            >
              Collaborate with your team, schedule meetings, share files, and
              track attendance all in one place.
            </p>
          </div>
        )}
      </div>
